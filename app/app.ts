...
var saveName = document.querySelector("#save-name") as HTMLInputElement;

var addCartao = document.querySelector("#adicionar-cartao") as HTMLInputElement;
...
var estimativa = document.querySelector("#estimativa") as any;



estimativa.addEventListener("keyup", (estimativa:any)=>{
